...
const units::Game kHealthBarSourceX{0.0f};
...
const units::Game kHealthDamageSourceX{0.0f};
...
const units::Game kMaxFillWidth{5 * units::kHalfTile};

const units::Game kHealthFillSourceX{0.0f};
...
const int kHealthNumberDigits{2};
